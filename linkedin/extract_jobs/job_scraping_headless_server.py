...
if __name__ == "__main__":
    ...
    if datetime.today().weekday() == 0:
        job_list = ['Data Scientist','Business Analyst']
    ...
    user=0
    for job in ['Data Scientist','Data Analyst','Business Analyst']:
        user_username=user_usernamelist[user]
        user_password=user_passwordlist[user]
        LinkedInJobScraper_class = LinkedInJobScraper()
        driver=LinkedInJobScraper_class.driver_launcher(username=user_username,password=user_password)
        for location in job_location:
            ...
            df=LinkedInJobScraper_class.scrape_jobs(driver,url,job_role_input=job,job_location=location)
        user+=1
